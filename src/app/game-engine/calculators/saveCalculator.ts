 ...
 */
export function calculateSaveTarget(armorSave: number, invulnSave: number | null, ap: number, inCover: boolean, ignoresCover: boolean, modifiers: RollModifier[]): SaveCalculationResult {
